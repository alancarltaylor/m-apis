...
var file_highscore_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x02, 0x76, 0x31, 0x22, 0x34, 0x0a, 0x13, 0x53, 0x65, 0x74, 0x48, 0x69, 0x67, 0x68,
	...
	0x52, 0x09, 0x68, 0x69, 0x67, 0x68, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x28, 0x0a, 0x14, 0x53,
	...
	,
}
...
var file_highscore_proto_goTypes = []interface{}{
	(*SetHighScoreRequest)(nil),  // 0: v1.SetHighScoreRequest
	(*SetHighScoreResponse)(nil), // 1: v1.SetHighScoreResponse
	(*GetHighScoreRequest)(nil),  // 2: v1.GetHighScoreRequest
	(*GetHighScoreResponse)(nil), // 3: v1.GetHighScoreResponse
}
var file_highscore_proto_depIdxs = []int32{
	0, // 0: v1.Game.SetHighScore:input_type -> v1.SetHighScoreRequest
	2, // 1: v1.Game.GetHighScore:input_type -> v1.GetHighScoreRequest
	1, // 2: v1.Game.SetHighScore:output_type -> v1.SetHighScoreResponse
	3, // 3: v1.Game.GetHighScore:output_type -> v1.GetHighScoreResponse
...
func (c *gameClient) SetHighScore(ctx context.Context, in *SetHighScoreRequest, opts ...grpc.CallOption) (*SetHighScoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.Game/SetHighScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameClient) GetHighScore(ctx context.Context, in *GetHighScoreRequest, opts ...grpc.CallOption) (*GetHighScoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.Game/GetHighScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Game_SetHighScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.Game/SetHighScore",
	}
...
func _Game_GetHighScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.Game/GetHighScore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
